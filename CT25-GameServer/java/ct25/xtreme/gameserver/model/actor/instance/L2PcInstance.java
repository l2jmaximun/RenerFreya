...
import ct25.xtreme.gameserver.ai.L2PlayerAI;
import ct25.xtreme.gameserver.ai.L2SummonAI;
import ct25.xtreme.gameserver.cache.HtmCache;
import ct25.xtreme.gameserver.cache.WarehouseCacheManager;
import ct25.xtreme.gameserver.communitybbs.BB.Forum;
import ct25.xtreme.gameserver.communitybbs.Manager.ForumsBBSManager;
...
import ct25.xtreme.gameserver.instancemanager.DuelManager;
...
import ct25.xtreme.gameserver.instancemanager.HandysBlockCheckerManager;
...
import ct25.xtreme.gameserver.model.L2Macro;
import ct25.xtreme.gameserver.model.L2ManufactureItem;
import ct25.xtreme.gameserver.model.L2ManufactureList;
import ct25.xtreme.gameserver.model.L2Object;
import ct25.xtreme.gameserver.model.L2Party;
import ct25.xtreme.gameserver.model.L2PetData;
import ct25.xtreme.gameserver.model.L2PetLevelData;
import ct25.xtreme.gameserver.model.L2PremiumItem;
import ct25.xtreme.gameserver.model.L2Radar;
import ct25.xtreme.gameserver.model.L2RecipeList;
...
import ct25.xtreme.gameserver.model.MacroList;
...
import ct25.xtreme.gameserver.model.actor.status.PcStatus;
import ct25.xtreme.gameserver.model.base.ClassId;
import ct25.xtreme.gameserver.model.base.ClassLevel;
import ct25.xtreme.gameserver.model.base.Experience;
...
import ct25.xtreme.gameserver.model.itemcontainer.PcRefund;
import ct25.xtreme.gameserver.model.itemcontainer.PcWarehouse;
import ct25.xtreme.gameserver.model.itemcontainer.PetInventory;
import ct25.xtreme.gameserver.model.multisell.PreparedListContainer;
import ct25.xtreme.gameserver.model.olympiad.OlympiadGameManager;
import ct25.xtreme.gameserver.model.olympiad.OlympiadGameTask;
...
import ct25.xtreme.gameserver.network.serverpackets.ExDominionWarStart;
import ct25.xtreme.gameserver.network.serverpackets.ExDuelUpdateUserInfo;
import ct25.xtreme.gameserver.network.serverpackets.ExFishingEnd;
import ct25.xtreme.gameserver.network.serverpackets.ExFishingStart;
import ct25.xtreme.gameserver.network.serverpackets.ExGetBookMarkInfoPacket;
import ct25.xtreme.gameserver.network.serverpackets.ExGetOnAirShip;
import ct25.xtreme.gameserver.network.serverpackets.ExOlympiadMode;
...
import ct25.xtreme.gameserver.network.serverpackets.ExSpawnEmitter;
...
import ct25.xtreme.gameserver.network.serverpackets.ExVitalityPointInfo;
import ct25.xtreme.gameserver.network.serverpackets.ExVoteSystemInfo;
import ct25.xtreme.gameserver.network.serverpackets.FriendStatusPacket;
import ct25.xtreme.gameserver.network.serverpackets.GameGuardQuery;
...
import ct25.xtreme.gameserver.network.serverpackets.LeaveWorld;
import ct25.xtreme.gameserver.network.serverpackets.MagicSkillUse;
import ct25.xtreme.gameserver.network.serverpackets.NicknameChanged;
import ct25.xtreme.gameserver.network.serverpackets.NpcHtmlMessage;
import ct25.xtreme.gameserver.network.serverpackets.ObservationMode;
import ct25.xtreme.gameserver.network.serverpackets.ObservationReturn;
import ct25.xtreme.gameserver.network.serverpackets.PartySmallWindowUpdate;
import ct25.xtreme.gameserver.network.serverpackets.PetInventoryUpdate;
import ct25.xtreme.gameserver.network.serverpackets.PlaySound;
import ct25.xtreme.gameserver.network.serverpackets.PledgeShowMemberListDelete;
import ct25.xtreme.gameserver.network.serverpackets.PledgeShowMemberListUpdate;
import ct25.xtreme.gameserver.network.serverpackets.PrivateStoreListBuy;
import ct25.xtreme.gameserver.network.serverpackets.PrivateStoreListSell;
import ct25.xtreme.gameserver.network.serverpackets.PrivateStoreManageListBuy;
import ct25.xtreme.gameserver.network.serverpackets.PrivateStoreManageListSell;
import ct25.xtreme.gameserver.network.serverpackets.PrivateStoreMsgBuy;
import ct25.xtreme.gameserver.network.serverpackets.PrivateStoreMsgSell;
import ct25.xtreme.gameserver.network.serverpackets.RecipeShopMsg;
import ct25.xtreme.gameserver.network.serverpackets.RecipeShopSellList;
import ct25.xtreme.gameserver.network.serverpackets.RelationChanged;
import ct25.xtreme.gameserver.network.serverpackets.Ride;
...
import ct25.xtreme.gameserver.network.serverpackets.ShortBuffStatusUpdate;
...
import ct25.xtreme.gameserver.network.serverpackets.SkillList;
import ct25.xtreme.gameserver.network.serverpackets.Snoop;
...
import ct25.xtreme.gameserver.network.serverpackets.TargetSelected;
import ct25.xtreme.gameserver.network.serverpackets.TargetUnselected;
import ct25.xtreme.gameserver.network.serverpackets.TradeDone;
import ct25.xtreme.gameserver.network.serverpackets.TradeOtherDone;
import ct25.xtreme.gameserver.network.serverpackets.TradeStart;
...
import ct25.xtreme.gameserver.skills.l2skills.L2SkillTrap;
import ct25.xtreme.gameserver.taskmanager.AttackStanceTaskManager;
import ct25.xtreme.gameserver.templates.chars.L2PcTemplate;
...
import ct25.xtreme.gameserver.util.FloodProtectors;
...
public final class L2PcInstance extends L2Playable
{
	...
	*/
	...
	/**
	 * 
	 * @see ct25.xtreme.gameserver.model.actor.L2Character#enableSkill(ct25.xtreme.gameserver.model.L2Skill)
	 */
	@Override
	 ...
	 *
	 *
	 * @see ct25.xtreme.gameserver.model.actor.L2Playable#doDie(ct25.xtreme.gameserver.model.actor.L2Character)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see ct25.xtreme.gameserver.model.actor.L2Character#isMovementDisabled()
	 */
	@Override
